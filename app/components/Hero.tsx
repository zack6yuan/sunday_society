    ...
    <section className="relative h-[60svh] lg:h-[80svh]">
      ...
      <div className="relative z-10 flex h-full items-end px-8 pb-8">
        <div className="flex flex-col items-start gap-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-extrabold text-white">
            SIX DAYS TO PRACTICE. <br /> ONE DAY TO PLAY.
          </h1>
          <button
            type="button"
            className="text-army font-sans font-black tracking-wide bg-white py-3 px-10 hover:bg-army hover:text-white transition duration-200 cursor-pointer"
          >
            SHOP THE FIRST DROP
          </button>
        </div>
